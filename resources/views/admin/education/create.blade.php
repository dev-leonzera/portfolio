            ...
            <form action="{{ route('admin.educations.store') }}" method="POST" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="degree_en" id="degree_en" class="form-input-premium" value="{{ old('degree_en') }}" placeholder="Ex: Bachelor in CS">
                        @error('degree_en')
                            <p class="text-red-500 text-[10px] uppercase font-bold mt-2 ml-1 tracking-widest">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <textarea name="description" id="description" rows="5" class="form-input-premium" placeholder="Descreva o que aprendeu...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-[10px] uppercase font-bold mt-2 ml-1 tracking-widest">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description_en" id="description_en" rows="5" class="form-input-premium" placeholder="Describe what you learned...">{{ old('description_en') }}</textarea>
