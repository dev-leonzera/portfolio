        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h2 class="text-2xl font-semibold mb-6">Editar Formação</h2>
                    ...
                    <form action="{{ route('admin.educations.update', $education) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="year_start" id="year_start" value="{{ old('year_start', $education->year_start) }}" min="1900" max="{{ date('Y') + 1 }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="year_end" id="year_end" value="{{ old('year_end', $education->year_end) }}" min="1900" max="{{ date('Y') + 1 }}"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="4" 
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('description') border-red-500 @enderror">{{ old('description', $education->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="order" id="order" value="{{ old('order', $education->order) }}" min="0" 
