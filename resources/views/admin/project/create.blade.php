            ...
            <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <input type="text" name="title" id="title" class="form-input-premium" value="{{ old('title') }}" placeholder="Nome do seu grande projeto" required>
                        @error('title')
                    ...
                    <div>
                        ...
                        <input type="text" name="title_en" id="title_en" class="form-input-premium" value="{{ old('title_en') }}" placeholder="Project title in English">
                        @error('title_en')
                            <p class="text-red-500 text-[10px] uppercase font-bold mt-2 ml-1 tracking-widest">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <textarea name="description" id="description" rows="5" class="form-input-premium" placeholder="Descreva os desafios..." required>{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-[10px] uppercase font-bold mt-2 ml-1 tracking-widest">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description_en" id="description_en" rows="5" class="form-input-premium" placeholder="Describe challenges in English...">{{ old('description_en') }}</textarea>
                ...
                <div>
                    <label for="image" class="form-label-premium">Thumbnail do Projeto</label>
                    <div class="relative group/file">
                        ...
                        <div class="w-full bg-white/5 border border-white/5 border-dashed rounded-xl py-8 px-6 text-center group-hover/file:border-gold-accent/30 transition duration-300">
                            ...
                            <p class="text-xs text-gray-400">Clique para selecionar ou arraste uma imagem</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <input type="url" name="project_link" id="project_link" class="form-input-premium" value="{{ old('project_link') }}" placeholder="https://demo.meuprojeto.com">
                        @error('project_link')
                            <p class="text-red-500 text-[10px] uppercase font-bold mt-2 ml-1 tracking-widest">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" name="github_link" id="github_link" class="form-input-premium" value="{{ old('github_link') }}" placeholder="https://github.com/usuario/projeto">
                        @error('github_link')
                            <p class="text-red-500 text-[10px] uppercase font-bold mt-2 ml-1 tracking-widest">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <input type="text" name="technologies" id="technologies" class="form-input-premium" value="{{ old('technologies') }}" placeholder="Ex: Laravel, Vue.js, MySQL" required>
                        @error('technologies')
                            <p class="text-red-500 text-[10px] uppercase font-bold mt-2 ml-1 tracking-widest">{{ $message }}</p>
                        @enderror
                    </div>
