            ...
            <form action="{{ route('admin.experiences.update', $experience) }}" method="POST" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="position_en" id="position_en" class="form-input-premium" value="{{ old('position_en', $experience->position_en) }}" placeholder="Ex: Senior Developer">
                        @error('position_en')
                            <p class="text-red-500 text-[10px] uppercase font-bold mt-2 ml-1 tracking-widest">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        ...
                        <textarea name="description" id="description" rows="5" class="form-input-premium" placeholder="Descreva suas responsabilidades...">{{ old('description', $experience->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-[10px] uppercase font-bold mt-2 ml-1 tracking-widest">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description_en" id="description_en" rows="5" class="form-input-premium" placeholder="Describe your responsibilities...">{{ old('description_en', $experience->description_en) }}</textarea>
