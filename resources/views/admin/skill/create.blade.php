                    ...
                    <form action="{{ route('admin.skills.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="percentage" id="percentage" class="form-input" value="{{ old('percentage') }}" min="0" max="100" required>
                            ...
                            <div>
                                ...
                                <input type="number" name="order" id="order" class="form-input" value="{{ old('order') }}" min="0" required>
