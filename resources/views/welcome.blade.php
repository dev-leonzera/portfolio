...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div>
                 ...
                 <div class="container mx-auto max-w-7xl">
                    ...
                    <div class="grid md:grid-cols-2 gap-8 lg:gap-12">
                        <div class="space-y-6 sm:space-y-8">
                            <div>
                                <h3 class="text-lg sm:text-xl font-semibold text-white mb-2">Informações de Contato</h3>
                                <p class="text-gray-400 text-sm sm:text-base leading-relaxed">Estou disponível para novos projetos e oportunidades. Entre em contato para conversarmos sobre como posso ajudar.</p>
                            </div>
                            <div class="flex items-start space-x-4">
                                <!-- Contact info items with improved spacing -->
                                <div class="flex flex-col space-y-6">
                                    <div class="flex items-center space-x-3 sm:space-x-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-amber-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                        </svg>
                                        <div>
                                            <h3 class="text-base sm:text-lg font-semibold text-white mb-1">Telefone</h3>
                                            <p class="text-gray-400 text-sm">(84) 99666-7335</p>
                                        </div>
                                    </div>
            ...
            <!-- Footer -->
            <footer class="bg-[#161B22] py-8 px-4 sm:px-6 lg:px-8 text-center text-gray-500 text-xs">
                 <div class="container mx-auto max-w-7xl">
                    <p>Copyright &copy; {{ date('Y') }} Leonardo Andrade. Todos os direitos reservados.</p>
                </div>
            </footer>
