...
.portfolio-about p, .portfolio-experience-item p, .contato p{
  text-align: justify;
  line-height: 2.0;
}
  ...
  <div class="container">
    ...
    <div class="portfolio box">
      <div class="portfolio-about">
        ...
        <br />
        <p>
          Apaixonado por tecnologia desde sempre e imerso no mundo do
          desenvolvimento web há quase 10 anos, sou um profissional dedicado, sempre
          disposto a entregar o máximo de esforço e valor através do meu
          trabalho. Tenho uma visão analítica e pensamento "out of the box", e
          busco sempre aprender coisas novas e aperfeiçoar o que eu já sei. Sabe
          aquela pessoa que você só precisa ensinar o serviço uma vez? Pois é,
          eu sou essa pessoa. Sou incansável na busca dos melhores resultados.
          Para mim, tarefa dada é tarefa cumprida!
        </p>
        <br />
        <p>
          Buscando sempre ajudar, gosto de estar presente na comunidade
          colaborando e compartilhando conhecimento, tirando as dúvidas dos
          iniciantes e aprendendo novos conceitos e tecnologias. Para mim, é
          muito gratificante.
        </p>
        <br />
        <p>
          Além de construir e consolidar minha carreira como Desenvolvedor, meus
          objetivos também envolvem aprender mais sobre Arquitetura de Software
          e também sobre Gestão de Projetos, para assim compreender todo o
          processo de desenvolvimento de software de ponta a ponta.
        </p>
      </div>
    </div>
    <div class="portfolio box">
    ...
    <div class="portfolio box">
      ...
      <div class="portfolio-experience">
        <div class="portfolio-experience-item">
          ...
          <br>
          <p>
            Responsável pela manutenção de projetos atuais e desenvolvimento de novas funcionalidades para sistemas web
        ...
        <div class="portfolio-experience-item">
          ...
          <h3>Desenvolvedor Fullstack</h3>
          <br>
          <h4>Jan 2022 - Atualmente</h4>
          <br>
          <p>
            Atuando como desenvolvedor web fullstack na manutenção de projetos atuais e desenvolvimento de novos
